...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "E:/Program Files (x86)/PCL 1.7.2/3rdParty/Boost/include/boost-1_55")
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "E:\Program Files (x86)\PCL 1.7.2\3rdParty\Eigen\eigen3" ABSOLUTE)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  find_package(Eigen)
...
macro(find_qhull)
  ...
  elseif(NOT QHULL_ROOT)
    get_filename_component(QHULL_ROOT "E:/Program Files (x86)/PCL 1.7.2/3rdParty/QHull/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    set(OPENNI2_INCLUDE_DIRS_HINT "F:/test/test/GP_OpenNI_2.2_1.1.6.3(3)/GP-TOF-OpenNI-Win/Include")
    get_filename_component(OPENNI2_LIBRARY_HINT "F:/test/test/GP_OpenNI_2.2_1.1.6.3(3)/GP-TOF-OpenNI-Win/Lib/OpenNI2.lib" PATH)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "E:\Program Files (x86)\PCL 1.7.2\3rdParty\FLANN\include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "F:\Program Files (x86)\VTK\lib\cmake\vtk-6.3" CACHE PATH "The directory containing VTKConfig.cmake")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "F:/pcl_source_1.7.2/pcl-master/pcl-master")
...
list(APPEND PCL_DEFINITIONS " /arch:SSE2  -D__SSSE3__ -D__SSE2__ -D__SSE__")

set(pcl_all_components  common kdtree octree search sample_consensus filters 2d geometry io features ml segmentation visualization surface registration keypoints tracking recognition stereo apps outofcore people )
...
set(pcl_io_opt_dep openni2 pcap png vtk )
